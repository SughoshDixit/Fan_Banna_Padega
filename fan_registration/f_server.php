...
if (isset($_POST['reg_user'])) {
 ...
 // first check the database to make sure 
  ...
  $user_check_query = "SELECT * FROM fans WHERE username='$username' OR email='$email' LIMIT 1";
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO fans (username, email, password, club) 
